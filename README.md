...
1. Download the latest macOS release (.dmg file) from the [Releases]([https://github.com/yourusername/your-repo-name/releases](https://github.com/mergisi/AI2sql-Generator/releases)) page.
